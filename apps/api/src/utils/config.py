...
class Config:
    ...
    os.getenv(
        ...
        self.compact_at_tokens = int(os.getenv("COMPACT_AT_TOKENS", "35000"))
        self.keep_recent_tokens = int(os.getenv("KEEP_RECENT_TOKENS", "8000"))
        ...
        self.redis_uri =os.getenv("REDIS_URL")
