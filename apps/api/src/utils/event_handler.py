    ...
    if event.type == EventType.USAGE:
        return WsEvent(
            ...
            usage={
                ...
                "session_prompt_tokens": data.get("session_prompt_tokens"),
                "session_completion_tokens": data.get("session_completion_tokens"),
                "session_total_tokens": data.get("session_total_tokens"),
                "session_cached_tokens": data.get("session_cached_tokens"),
                "session_estimated_cost_usd": data.get("session_estimated_cost_usd"),
